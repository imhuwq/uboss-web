class Admin::CityManagerAuthenticationsController < AdminController
  load_and_authorize_resource
  include Certifications

  def klass
    CityManagerAuthentication
  end
  ...
  def valid_create_params
    ...
    hash = {
      ...
      '营业执照不能为空。': params[:city_manager_authentication][:business_license_img],
      '身份证照片正面不能为空。': params[:city_manager_authentication][:legal_person_identity_card_front_img],
      '身份证照片反面不能为空。': params[:city_manager_authentication][:legal_person_identity_card_end_img],
