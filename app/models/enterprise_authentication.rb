class EnterpriseAuthentication < Certification
  ...
  mount_uploader :legal_person_identity_card_front_img, ImageUploader, mount_on: :attachment_2
  mount_uploader :legal_person_identity_card_end_img, ImageUploader, mount_on: :attachment_3
